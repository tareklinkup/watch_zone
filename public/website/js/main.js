(function ($) {
    ...
    if (
        ...
        if (hash != "")
            $(".header-navigation li a[href='" + hash + "']")
                .parents("li")
                .addClass("active");
        else
            $(".header-navigation li a[href='" + curpage + "']")
                .parents("li")
                .addClass("active");
    }
        ...
        if ($lis.length > 0) {
            $ul.append(
                $(
                    '<li class="expand">' +
                        (isExpanded
                            ? '<a class="minus" href="javascript:void(0);"><span>- Close Brand</span></a>'
                            : '<a href="javascript:void(0);"><span>+ More Brand</span></a>') +
                        "</li>"
    ...
    $("[data-countdown]").each(function () {
        ...
        $this.countdown($finalDate, function (event) {
            $this.html(
                event.strftime(
                    '<div class="count"><span class="amount">%-D</span><span class="period">D<span class="period-desc">ays</span></span></div><div class="count"><span class="amount">%-H</span><span class="period">H<span class="period-desc">RS</span></span></div><div class="count"><span class="amount">%-M</span><span class="period">M<span class="period-desc">IN</span></span></div><div class="count"><span class="amount">%-S</span><span class="period">S<span class="period-desc">EC</span></span></div>'
                )
            );
        });
    });
