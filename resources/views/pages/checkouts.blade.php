                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="billing-select mb-4">
                                            ...
                                            <div class="select-style">
                                                <select class="select-active" id="district" required>
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="additional-info-wrap">
                                            <label> Address <small class="text-danger" title="required">*</small></label>
                        ...
                        <div class="col-lg-6">
                            <div class="your-order-area mt-10 mt-lg-0">
                                ...
                                <div class="your-order-wrap">
                                    <div class="your-order-info-wrap">
                                                ...
                                                @foreach ($carts as $cart)
                                                    <li class="border-bottom">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-2"><span>৳ {{ $cart->subtotal }} </span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endforeach
                                        ...
                                        <div class="your-order-subtotal">
                                            ...
                                            <input style="display: none;" type="text" class="form-control shadow-none"
                                                id="SubAmount" value="{{ $cartTotal }}">
                                        </div>
                                        ...
                                        <div class="your-order-subtotal">
                                            <h3>Payment Type <span>
                                                    <div class="clearfix">
                                                        <input id="payment_type" name="payment_type" value="Cash on Delivery"
                                                            type="radio" checked>
                                ...
                                @guest('customer')
                                    ...
                                    <a href="{{ route('customer.login.process') }}" class="btn btn--lg w-100">Place Order</a>
                                @endguest
