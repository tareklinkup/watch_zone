        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 aside mt-5">
                    <h1 class="mb-3 order_submit"><i class="fa fa-check" aria-hidden="true"></i> Your Order has Submitted Successfully.</h1>
                    {{-- <p>Thank you. Your order has been received.</p> --}}

                    <div class="row pb-3 border m-1">
                        <div class="col-lg-2">
                            <div class="feature-item" >
                                <p><strong>Order No :</strong> <span id="markup" class="px-1" style="font-size: 12px">{{ $order->order_number }}</span></p>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="feature-item" >
                        ...
                        <div class="customer_profile table-responsive mt-3 col-md-12 aside mb-4">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td><img src="{{ asset('uploads/product/' .$item->product->image) }}" height="80px;" width="80px;" alt="imga"></td>
                            ...
                            <div class="card d-block d-md-none">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center border-bottom"><img src="{{ asset($item->product->image) }}" height="80px;" width="80px;" alt="imga"></div>
                                        ...
                                        <div class="col-8 text-end"> {{ number_format($item->price * $item->quantity, 2) }}</div>
                                    </div>
                                    @endforeach
