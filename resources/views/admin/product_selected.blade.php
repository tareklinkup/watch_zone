...
@section('main-content')
    ...
    <main>
        <div class="container-fluid">
            ...
            <form action="{{ route('search.catbybrand.select') }}" method="POST">
                @csrf
            ...
            <form method="POST" action="{{ route('product.selected') }}">
                @csrf
                <div class="row">
                    <div class="card my-3">
                        <div class="row ">
                            <div class="col-sm-6">
                                <div class="from-group row">
                                    <div class="col-sm-3">
                                        <label for="banner_id" class=""> <strong>Banner</strong> </label>
                                    </div>
                                    <div class="col-sm-5">
