            ...
            <div class="row">
                <div class="card my-3">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @can('Product Add')
                            <a href="{{ route('products.create') }}" class="btn btn-addnew shadow-none"> <i
                        ...
                        <table id="datatablesSimple" class="text-center">
                            ...
                            <tbody>
                                @foreach ($products as $key => $product)
                                    <tr class="">
                                        <td>{{ $key + 1 }}</td>
                                        <td><img src="{{ asset('uploads/product/' . $product->image) }}" width="30"
                                                height="30" alt=""></td>
                                        <td>{{ $product->name }}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('products.show', $product->id) }}" class="btn btn-edit"><i
                                            ...
                                            @endcan
                                            @can('Product Delete')
                                                <a href="{{ route('products.delete') }}" id="delete"
