    ...
    <main>
        <div class="container-fluid" id="Category">
            <div class="heading-title p-2 my-2">
                <span class="my-3 heading "><i class="fas fa-home"></i> <a class="" href="{{route('dashboard')}}">Home</a> > Delivered
                    Order</span>
            </div>
            <div class="row">
                <div class="col-12">
                    <div id="invoiceContent" class="card my-2">
                        <div class="card-header d-flex justify-content-between">
                            <div class="table-head"><i class="fas fa-table me-1"></i> Delivered Order List</div>
                                    ...
                                    <tbody>
                                        @foreach ($order as $item)
                                            <tr class="{{ $item->id }}">
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.delivered.to.processing', $item->id) }}"
                                                        title="Back" class="btn btn-edit shadow-none"><i
                                                            class="fa fa-arrow-left"></i></a>
                                                    <a href="{{ route('admin.show.order', $item->id) }}"
                                                        title="View Details" class="btn btn-edit shadow-none shadow-none"><i
