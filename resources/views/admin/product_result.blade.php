...
@section('main-content')
    ...
    <main>
        <div class="container-fluid">
            ...
            <form action="{{ route('search.catbybrand') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-4">
            ...
            <form method="post" action="{{route('product.discount')}}">
                @csrf
                <div class="row">
                    <div class="card my-3">
                        <div class="row ">
                                ...
                                <div class="from-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="number" name="discount"
                                            class="col-sm-5 form-control form-control-sm shadow-none" min="0"
                                ...
                                <tbody>
                                    @foreach ($products as $key => $product)
                                        <tr class="">
                                            ...
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <input class="checkbox" type="checkbox" name="selectedProduct[]" id="selectedProduct[]" value="{{ $product->id }}" />
